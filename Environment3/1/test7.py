...
class RoomEnvironment(tk.Tk, object):
    ...
    def _build_environment(self):
        ...
        self.obstacle13 = self.canvas.create_rectangle(6 * UNIT, 2 * UNIT, 7 * UNIT, 3 * UNIT, fill='black')
        self.obstacle14 = self.canvas.create_rectangle(6 * UNIT, 3 * UNIT, 7 * UNIT, 4 * UNIT, fill='black')
        self.obstacle15 = self.canvas.create_rectangle(6 * UNIT, 4 * UNIT, 7 * UNIT, 5 * UNIT, fill='black')
        self.obstacle16 = self.canvas.create_rectangle(6 * UNIT, 5 * UNIT, 7 * UNIT, 6 * UNIT, fill='black')
        self.obstacle17 = self.canvas.create_rectangle(6 * UNIT, 6 * UNIT, 7 * UNIT, 7 * UNIT, fill='black')
        self.obstacle18 = self.canvas.create_rectangle(6 * UNIT, 7 * UNIT, 7 * UNIT, 8 * UNIT, fill='black')
        self.obstacle19 = self.canvas.create_rectangle(6 * UNIT, 8 * UNIT, 7 * UNIT, 9 * UNIT, fill='black')
        self.obstacle23 = self.canvas.create_rectangle(6 * UNIT, 9 * UNIT, 7 * UNIT, 10 * UNIT, fill='black')
        
        self.obstacle20 = self.canvas.create_rectangle(9 * UNIT, 2 * UNIT, 10 * UNIT, 3 * UNIT, fill='black')
        self.obstacle21 = self.canvas.create_rectangle(9 * UNIT, 2 * UNIT, 10 * UNIT, 3 * UNIT, fill='black')

        self.obstacle22 = self.canvas.create_rectangle(6 * UNIT, 9 * UNIT, 7 * UNIT, 10 * UNIT, fill='black')
        self.obstacle23 = self.canvas.create_rectangle( 0* UNIT, 9 * UNIT, 1 * UNIT, 10 * UNIT, fill='black')
