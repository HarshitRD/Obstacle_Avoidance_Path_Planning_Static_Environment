...
class RoomEnvironment(tk.Tk, object):
    ...
    def _build_environment(self):
        ...
        self.obstacle2 = self.canvas.create_rectangle(3 * UNIT, 0 * UNIT, 4 * UNIT, 1 * UNIT, fill='black')
        self.obstacle4 = self.canvas.create_rectangle(3 * UNIT, 1 * UNIT, 4 * UNIT, 2 * UNIT, fill='black')
        self.obstacle3 = self.canvas.create_rectangle(3 * UNIT, 2 * UNIT, 4 * UNIT, 3 * UNIT, fill='black')
        # self.obstacle5 = self.canvas.create_rectangle(3 * UNIT, 3 * UNIT, 4 * UNIT, 4 * UNIT, fill='black')
        # self.obstacle6 = self.canvas.create_rectangle(3 * UNIT, 4 * UNIT, 4 * UNIT, 5 * UNIT, fill='black')
        # self.obstacle7 = self.canvas.create_rectangle(3 * UNIT, 5 * UNIT, 4 * UNIT, 6 * UNIT, fill='black')

        # self.obstacle8 = self.canvas.create_rectangle(2 * UNIT, 5 * UNIT, 3 * UNIT, 6 * UNIT, fill='black')
        # self.obstacle9 = self.canvas.create_rectangle(2 * UNIT, 6 * UNIT, 3 * UNIT, 7 * UNIT, fill='black')
        # self.obstacle10 = self.canvas.create_rectangle(2 * UNIT, 7 * UNIT, 3 * UNIT, 8 * UNIT, fill='black')

       # self.obstacle11 = self.canvas.create_rectangle(4 * UNIT, 2 * UNIT, 5 * UNIT, 3 * UNIT, fill='black')
        # self.obstacle12 = self.canvas.create_rectangle(9 * UNIT, 6 * UNIT, 10 * UNIT, 7 * UNIT, fill='black')
        
        self.obstacle16 = self.canvas.create_rectangle(6 * UNIT, 1 * UNIT, 7 * UNIT, 2 * UNIT, fill='black')
        self.obstacle15 = self.canvas.create_rectangle(6 * UNIT, 3 * UNIT, 7 * UNIT, 4 * UNIT, fill='black')
        self.obstacle1 = self.canvas.create_rectangle(2 * UNIT, 7 * UNIT, 3 * UNIT, 8 * UNIT, fill='black')
        self.obstacle5 = self.canvas.create_rectangle(3 * UNIT, 6 * UNIT, 4 * UNIT, 7 * UNIT, fill='black')
        self.obstacle6 = self.canvas.create_rectangle(2 * UNIT, 6 * UNIT, 3 * UNIT, 7 * UNIT, fill='black')
        self.obstacle7 = self.canvas.create_rectangle(3 * UNIT, 7 * UNIT, 4 * UNIT, 8 * UNIT, fill='black')
        self.obstacle8 = self.canvas.create_rectangle(6 * UNIT, 7 * UNIT, 7 * UNIT, 8 * UNIT, fill='black')
        self.obstacle9 = self.canvas.create_rectangle(6 * UNIT, 8 * UNIT, 7 * UNIT, 9 * UNIT, fill='black')
        self.obstacle10 = self.canvas.create_rectangle(6 * UNIT, 9 * UNIT, 7 * UNIT, 10 * UNIT, fill='black')
        
        self.obstacle11 = self.canvas.create_rectangle(9 * UNIT, 2 * UNIT, 10 * UNIT, 3 * UNIT, fill='black')
        self.obstacle12 = self.canvas.create_rectangle(9 * UNIT, 2 * UNIT, 10 * UNIT, 3 * UNIT, fill='black')

        self.obstacle13 = self.canvas.create_rectangle(6 * UNIT, 9 * UNIT, 7 * UNIT, 10 * UNIT, fill='black')
        self.obstacle14 = self.canvas.create_rectangle( 0* UNIT, 9 * UNIT, 1 * UNIT, 10 * UNIT, fill='black')
