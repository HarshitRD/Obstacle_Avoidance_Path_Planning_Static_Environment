...
class RoomEnvironment(tk.Tk, object):
    ...
    def _build_environment(self):
        ...
        self.obstacle1 = self.canvas.create_rectangle(2 * UNIT, 1 * UNIT, 3 * UNIT, 2 * UNIT, fill='black')
        self.obstacle2 = self.canvas.create_rectangle(3 * UNIT, 1 * UNIT, 4 * UNIT, 2 * UNIT, fill='black')
        self.obstacle4 = self.canvas.create_rectangle(4 * UNIT, 1 * UNIT, 5 * UNIT, 2 * UNIT, fill='black')
        self.obstacle3 = self.canvas.create_rectangle(5 * UNIT, 1 * UNIT, 6 * UNIT, 2 * UNIT, fill='black')
        self.obstacle5 = self.canvas.create_rectangle(4 * UNIT, 2 * UNIT, 5 * UNIT, 3 * UNIT, fill='black')

        self.obstacle6 = self.canvas.create_rectangle(4 * UNIT, 3 * UNIT, 5 * UNIT, 4 * UNIT, fill='black')
        self.obstacle7 = self.canvas.create_rectangle(4 * UNIT, 4 * UNIT, 5 * UNIT, 5 * UNIT, fill='black')
        self.obstacle8 = self.canvas.create_rectangle(4 * UNIT, 5 * UNIT, 5 * UNIT, 6 * UNIT, fill='black')
        self.obstacle9 = self.canvas.create_rectangle(4 * UNIT, 6 * UNIT, 5 * UNIT, 7 * UNIT, fill='black')
        self.obstacle10 = self.canvas.create_rectangle(6 * UNIT, 4 * UNIT, 7 * UNIT, 5 * UNIT, fill='black')

        self.obstacle11 = self.canvas.create_rectangle(0 * UNIT, 2 * UNIT, 1 * UNIT, 3 * UNIT, fill='black')
        self.obstacle12 = self.canvas.create_rectangle(0 * UNIT, 3 * UNIT, 1 * UNIT, 4 * UNIT, fill='black')
        self.obstacle13 = self.canvas.create_rectangle(0 * UNIT, 4 * UNIT, 1 * UNIT, 5 * UNIT, fill='black')
        self.obstacle14 = self.canvas.create_rectangle(2 * UNIT, 3 * UNIT, 3 * UNIT, 4 * UNIT, fill='black')
        self.obstacle15 = self.canvas.create_rectangle(2 * UNIT, 4 * UNIT, 3 * UNIT, 5 * UNIT, fill='black')

        self.obstacle16 = self.canvas.create_rectangle(2 * UNIT, 5 * UNIT, 3 * UNIT, 6 * UNIT, fill='black')
        self.obstacle17 = self.canvas.create_rectangle(2 * UNIT, 6 * UNIT, 3 * UNIT, 7 * UNIT, fill='black')
    ...
    def step(self, action):
        ...
        la=[self.canvas.coords(self.obstacle1), self.canvas.coords(self.obstacle2),
            self.canvas.coords(self.obstacle3),self.canvas.coords(self.obstacle4),
            self.canvas.coords(self.obstacle5),self.canvas.coords(self.obstacle6),
            self.canvas.coords(self.obstacle7),self.canvas.coords(self.obstacle8),
            self.canvas.coords(self.obstacle9), self.canvas.coords(self.obstacle10),
            self.canvas.coords(self.obstacle11),self.canvas.coords(self.obstacle12),
            self.canvas.coords(self.obstacle13), self.canvas.coords(self.obstacle14),
            self.canvas.coords(self.obstacle15),self.canvas.coords(self.obstacle16)]
            # self.canvas.coords(self.obstacle17), self.canvas.coords(self.obstacle18),
            # self.canvas.coords(self.obstacle19),self.canvas.coords(self.obstacle20),
            # self.canvas.coords(self.obstacle21),self.canvas.coords(self.obstacle22),
            # self.canvas.coords(self.obstacle23),self.canvas.coords(self.obstacle24),
            # self.canvas.coords(self.obstacle25)]
